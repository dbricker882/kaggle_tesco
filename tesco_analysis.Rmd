...
Orders and profit are driven by 5 countries, France, Germany, United Kingdom, Italy, and Spain. While orders from Netherlands, Sweden, Ireland, Denmark, and Portugal have resulted in a net loss between 2011-2015.

The goal of this analysis is to recommend strategies for expanding or increasing presence in different markets. With this in mind let's dig into these negative profit countries (henceforth referred to as net loss countries).

## Investigating Negative Profit Countries
...
The chart below shows the proportion of orders placed with a discount in the net loss countries compared to countries compared to profitable countries.
...
It can be concluded that the frequency of discounted orders in the net loss states was intentional by the business or at least not a result of customers taking advantage of a loophole.
